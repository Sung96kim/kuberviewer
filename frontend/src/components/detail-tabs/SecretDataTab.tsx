  ...
  return (
    <div className="px-6 py-4 flex items-center gap-4">
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2 px-3 py-2 rounded-md bg-slate-50 dark:bg-slate-950 border border-border-light dark:border-border-dark font-mono text-sm">
          {revealed ? (
          ...
          <div className="flex items-center gap-1 shrink-0">
            <button
              ...
              className="p-1 rounded hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-400 dark:text-slate-500 hover:text-slate-700 dark:hover:text-slate-300 transition-colors"
